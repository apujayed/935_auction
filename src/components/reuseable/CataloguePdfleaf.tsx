...
const CataloguePdfleaf = (filter_cat,seasonSELECTED,saleSELECTED,broker_name) => {


const tickets =filter_cat.filter((item)=>item.Category ==="LEAF" )   
...
let margin = (pageWidth - wantedTableWidth) / 2;
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    const pageSize = doc.internal.pageSize;
    const pageWidth = pageSize.width ? pageSize.width : pageSize.getWidth();
    const footer = `Leaf Page ${i} of ${pageCount}`;
...
export default CataloguePdfleaf;