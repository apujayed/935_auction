...
function ActionDetails(passed_min) {
...
//       });
  ...
  // const filer_unsold = modify_data.filter(data => data.status===false);
    ...
    return (
        ...
        <div className=" hidden md:block  bg-white rounded-lg h-fit  w-full col-span-2">
  ...
  <div className="flex flex-col">
    ...
    >
      ...
      {data1?.map((item, index) => {
        ...
        return(
            <tr className={passed_min.passed_min === index ? 'bg-green-200 text-white' : ''}>
